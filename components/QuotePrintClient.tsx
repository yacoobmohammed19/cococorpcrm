    ...
    <>
      <style>{`
        ...
        @media print {
          ...
          /* make every input look like plain text */
          .inv-doc input,
          .inv-doc select,
          .inv-doc textarea {
      ...
      <div className="inv-doc">
        ...
        <h1 style={{ fontFamily: "var(--font-geist-sans), Arial, sans-serif", fontSize: 28, fontWeight: 700, color: "#111", marginBottom: 28, letterSpacing: -0.5 }}>Quote</h1>
        ...
        <div className="inv-info-grid">
          <table style={{ width: "100%", fontSize: 13, borderCollapse: "collapse", color: "#333" }}>
            <tbody>
              <tr><td colSpan={2} style={{ fontWeight: 700, fontSize: 11, textTransform: "uppercase", letterSpacing: 1, color: "#999", paddingBottom: 6 }}>Quote Details</td></tr>
              <tr>
                <td style={tdLabel}>Quote #</td>
          ...
          <table style={{ width: "100%", fontSize: 13, borderCollapse: "collapse", color: "#333" }}>
            <tbody>
              <tr><td colSpan={2} style={{ fontWeight: 700, fontSize: 11, textTransform: "uppercase", letterSpacing: 1, color: "#999", paddingBottom: 6 }}>Quoted To</td></tr>
              <tr>
              ...
              <table style={{ width: "100%", fontSize: 13, borderCollapse: "collapse", color: "#444", lineHeight: 1.8 }}>
                <tbody>
                  {([
                    ...
                    ["Reference", quote.quote_number, () => {}, quote.quote_number],
                  ] as [string, string, (v: string) => void, string][]).map(([l, v, set, ph]) => (
                    <tr key={l}>
